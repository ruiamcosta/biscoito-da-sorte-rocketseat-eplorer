...
const cookieImg = screen1.querySelector('img')
const fortuneMessage = screen2.querySelector('p')
const button = screen2.querySelector('button')

const fortuneCookiesMessages = [
...
const randomMessage = () => {
  return Math.round(Math.random() * fortuneCookiesMessages.length)
}
...
button.addEventListener('click',() => {
  toggleScreen('hide')
  fortuneMessage.innerText = fortuneCookiesMessages[randomMessage()]
})